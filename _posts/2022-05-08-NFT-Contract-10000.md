---
title: "Загрузить 10000 NFT в IPFS"
author:
  name: "Денис"
  link: https://github.com/denilev
date: 2022-05-08 21:50:00 +0300
categories: [Solidity, NFT]
tags: [contracts]
---

Контракт по запуску множества NFT с гибкой настройкой параметров. [HashLips](https://youtu.be/3jizwk6_m1s)

### Код контракта NFT.sol

```solidity
// SPDX-License-Identifier: GPL-3.0

// My revision of HashLips code 
/**
...
async function main() {
  ...
  const nft = await NFT.deploy("Mahoori", "MHR", "ipfs://QmeJ88g5bir68WAYBE6qxgj3f3JEmjhrKhmbohR5Qc6aSy/")
